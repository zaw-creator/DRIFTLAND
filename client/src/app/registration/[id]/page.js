...
function ViewRegistrationPageContent() {
  ...
  const canEdit = registration && registration.event && registration.event.canEdit;
    ...
    return (
      <div className={styles.container}>
        <div className={styles.errorCard}>
          <h2>Error</h2>
          <p>{error}</p>
          <Link href="/registration/lookup" className={styles.button}>Try Again</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className={styles.container}>
        <div className={styles.errorCard}>
          ...
          <Link href="/registration/lookup" className={styles.button}>Search Again</Link>
        </div>
      </div>
    );
  }
      ...
      <div className={styles.card}>
        <div className={styles.cardInner}>
          <div className={styles.header}>
            ...
            <div className={`${styles.status} ${getStatusColor(registration.status)}`}>
          ...
          {registration.status === "verified" && registration.qrCode && (
            <div className={styles.qrSection}>
              <h2>Event QR Code</h2>
              <img src={registration.qrCode} alt="Event QR Code" className={styles.qrCode} />
              <p className={styles.qrHint}>Present this QR code at the event check-in</p>
            </div>
          )}
          ...
          <div className={styles.section}>
            ...
            <div className={styles.grid}>
              ...
              <div className={styles.field}>
                ...
                <p>{new Date(registration.driver.dateOfBirth).toLocaleDateString()}</p>
              </div>
            </div>
          </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.grid}>
              <div className={styles.field}>
                ...
                <p>{registration.vehicle.make} {registration.vehicle.model}</p>
              </div>
              <div className={styles.field}>
                <label>Year</label>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.grid}>
              ...
              <div className={styles.field}>
                ...
                <p>{new Date(registration.event.eventDate).toLocaleDateString("en-US", { weekday: "long", year: "numeric", month: "long", day: "numeric" })}</p>
              </div>
              <div className={styles.field}>
