  ...
  async sendRegistrationPendingEmail(registrationData) {
    ...
    try {
      await this.resend.emails.send({
        from: 'DriftLand <onboarding@nyokidrift.com>',
        to: driver.email,
            ...
            <div style="max-width:600px;margin:0 auto;background-color:#0d0d0d;border:1px solid #1a1a1a;">
              ...
              <div style="padding:2rem;">
                ...
                <div style="background-color:#111;border:1px solid #1a1a1a;border-radius:4px;padding:1.25rem;margin-bottom:1.5rem;">
                  ...
                  <div style="margin-bottom:0.75rem;display:flex;gap:0.75rem;align-items:flex-start;">
                    <div style="background-color:#1a1200;border:1px solid #FFBB00;color:#FFBB00;font-size:0.7rem;font-weight:700;min-width:1.5rem;height:1.5rem;border-radius:50%;text-align:center;line-height:1.5rem;">1</div>
                    <div>
                  ...
                  <div style="margin-bottom:0.75rem;display:flex;gap:0.75rem;align-items:flex-start;">
                    <div style="background-color:#1a1200;border:1px solid #FFBB00;color:#FFBB00;font-size:0.7rem;font-weight:700;min-width:1.5rem;height:1.5rem;border-radius:50%;text-align:center;line-height:1.5rem;">2</div>
                    <div>
                  ...
                  <div style="display:flex;gap:0.75rem;align-items:flex-start;">
                    <div style="background-color:#1a1200;border:1px solid #FFBB00;color:#FFBB00;font-size:0.7rem;font-weight:700;min-width:1.5rem;height:1.5rem;border-radius:50%;text-align:center;line-height:1.5rem;">3</div>
                    <div>
